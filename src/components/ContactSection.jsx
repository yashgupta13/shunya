          ...
          {!isSubmitted ? (
            <>
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold text-slate-900 mb-2">Secure Your Audit Defense</h2>
                <p className="text-slate-500 text-sm">Join the early access program for enterprise teams.</p>
              </div>

              <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
                
                <div>
                  <label className="block text-sm font-semibold text-slate-900 mb-1.5">Work Email <span className="text-red-500">*</span></label>
                  <input 
                    required
                    type="email" 
                    name="email"
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-900 mb-1.5">Role <span className="text-red-500">*</span></label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-slate-900 mb-1.5">What worries you most?</label>
                  <textarea 
                    rows={3}
                    name="message"
                ...
                <Button fullWidth className="mt-2" type="submit" disabled={isSubmitting}>
                  {isSubmitting ? (
                    <>
